...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { category: @gallery.category, image: @gallery.image, image_description: @gallery.image_description, image_title: @gallery.image_title, item_for_sale: @gallery.item_for_sale } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { category: @gallery.category, image: @gallery.image, image_description: @gallery.image_description, image_title: @gallery.image_title, item_for_sale: @gallery.item_for_sale } }
