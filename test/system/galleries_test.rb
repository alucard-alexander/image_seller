...
class GalleriesTest < ApplicationSystemTestCase
  ...
  test "creating a Gallery" do
    ...
    fill_in "Category", with: @gallery.category
    fill_in "Image", with: @gallery.image
    fill_in "Image description", with: @gallery.image_description
    fill_in "Image title", with: @gallery.image_title
    check "Item for sale" if @gallery.item_for_sale
